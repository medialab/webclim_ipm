...
It is in this way that the present research paper distinguishes itself from the articles that measured overal
l levels of misinformation on the platform \citep{allcott2019trends, kornbluh2020new, resnick2018iffy}. 
...
We found a small decrease in engagement following the `reduced distribution' notification, but the effect was small compared with the `June drop' previously described, and it varied greatly accross the different Facebook pages.
