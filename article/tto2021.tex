...
\caption{Average engagement per post over the past two years for one example Facebook group spreading misinformation repeatedly. Each red line at the bottom of a subplot represents the date of a known strike, and the areas shaded in red represent the `repeat offender' periods as defined by the ‘two strikes in 90 days’ rule. The areas not shaded in red correspond to ‘no strike’ periods.}
