...
To generalize, we calculate the percentage change between the `repeat offender' and the `no strike' periods for each of the 256 Facebook accounts that published at least one post during each periods (see Figure \ref{repeat_vs_free_percentage_change})
