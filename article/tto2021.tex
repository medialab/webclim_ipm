...
We manually opened the hundreds of resulting posts, and kept the posts we found to meet the following criteria (see Figure \ref{screenshot_reduce_example} for an example):
\begin{itemize}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\linewidth]{./../figure/screenshot_reduce_example.png}
...
\label{screenshot_reduce_example}
\end{figure}
