...
When we compare the engagement metrics before and after June 9, 2020, the percentage changes are not significantly different from zero (W = $1093$, p-value = $0.055$), and the median percentage change is $3\%$ (also see Supplementary Figure \ref{engagement_groups_and_pages_reduce} to observe a lack of change in the engagement per post for these pages in 2019-2020).
...
\caption{
Screenshot of \href{https://www.facebook.com/groups/mcbowwow/posts/3893068180741848/}{the post of a `repeat offender' group}, sharing a `reduced distribution' notification sent by Facebook.
}
...
\caption{
Average engagement per post in 2019-2020 for the 83 `reduced distribution' pages, identified because they shared a `reduced distribution' notification from Facebook.
}
...
We again found a significant overlap between the page list for two first analyses, as 8 pages out of the 18 pages identified by the Science Feedback data were also found using the Condor data.
