...
The median percentage change after June 9, 2020 was $-5\%$ for these `control' accounts, and the values were not different from zero for the groups (p-value = $0.63$) and the pages (p-value = $1$).
